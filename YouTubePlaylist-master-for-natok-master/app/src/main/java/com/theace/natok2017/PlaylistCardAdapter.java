...
import com.theace.natok2017.model.PlaylistVideos;
       ...
       // holder.mDescriptionText.setText(videoSnippet.getDescription());
        ...
        holder.mThumbnailImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String vidID=video.getId().toString(); //by tareq
         
         //by tareq//       holder.mContext.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.youtube.com/watch?v=" + video.getId())));
              //  Toast.makeText(holder.mContext, ""+vidID, Toast.LENGTH_SHORT).show();//by tareq
                playvideo.videoID=vidID;
               holder.mContext.startActivity(new Intent(holder.mContext,playvideo.class));
                //new playvideo().showCustomAlert();
